...
/**
 * PrismaticBurst：WebGL 棱镜爆发效果。
 *
 * 使用 OGL 库渲染光线折射动画，为创意工坊提供视觉吸引力。
 * 从 React 版本转换而来，保持原始 shader 逻辑。
 */
...
onMounted(() => {
  ...
  gl.canvas.style.mixBlendMode =
    props.mixBlendMode && props.mixBlendMode !== "none" ? props.mixBlendMode : "";
